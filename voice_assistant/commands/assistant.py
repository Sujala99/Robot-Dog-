...
wake_word = 'dog'
groq_client = Groq(api_key='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')
...
def speak(text):
    ...
    # Add the text to speak to the queue
    engine.say(text)
    
    # Process the voice commands in the queue
    engine.runAndWait()
